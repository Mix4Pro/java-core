...
public class Run {
    public static void main(String[] args) {
        ...
        aircraft.setADepartureTime(LocalDateTime.of(2025, 12, 31, 23, 0));
        ...
        while (choice != 6) {
            ...
            System.out.println("5) Buy a seat");
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.print("Enter the seat id that you want to buy : ");
                    String place_id_buy = scanner.nextLine();

                    System.out.print("Enter the name of the buyer : ");
                    String buy_name = scanner.nextLine();

                    aircraft.buyAPlace(place_id_buy, buy_name);
                    break;
                case 6:
                    break;
                default:
